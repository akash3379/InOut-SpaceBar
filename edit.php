...
$note=$_POST["note"];
$num=$_SESSION["no"];
$update="UPDATE  `$user` SET  `subject` =  '$sub',
`note` =  '$note' WHERE  `$user`.`no.` =$num";
$rew=mysql_query($update) or die("not");
header("location:see.php?edit=1");
